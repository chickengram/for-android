...
public class ApplicationLoaderImpl extends ApplicationLoader {
    ...
    protected void startAppCenterInternal(Activity context) {
        if (com.chickengram.messenger.BuildConfig.DEBUG) {
            return;
        }
        try {
            if (BuildVars.DEBUG_VERSION) {
                ...
                crashlytics.setCustomKey("version", getVersionName(com.chickengram.messenger.BuildConfig.VERSION_NUM));
            ...
            if (BuildVars.DEBUG_VERSION) {
                ...
                String appHash = com.chickengram.messenger.BuildConfig.APP_CENTER_HASH;
...
//        }
    ...
    public boolean isCustomUpdate() {
        return !TextUtils.isEmpty(com.chickengram.messenger.BuildConfig.BETA_URL);
    }
