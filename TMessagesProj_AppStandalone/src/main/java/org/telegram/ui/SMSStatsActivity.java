...
import static com.chickengram.messenger.AndroidUtilities.dp;
import static com.chickengram.messenger.AndroidUtilities.dpf2;
import static com.chickengram.messenger.AndroidUtilities.isInAirplaneMode;
import static com.chickengram.messenger.LocaleController.formatPluralString;
import static com.chickengram.messenger.LocaleController.formatString;
import static com.chickengram.messenger.LocaleController.getString;
...
import com.chickengram.messenger.AndroidUtilities;
import com.chickengram.messenger.Emoji;
import com.chickengram.messenger.FileLog;
import com.chickengram.messenger.LocaleController;
import com.chickengram.messenger.LocationController;
import com.chickengram.messenger.NotificationCenter;
import com.chickengram.messenger.SMSJobController;
import com.chickengram.messenger.browser.Browser;
import com.chickengram.messenger.web.R;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case VIEW_TYPE_SHADOW:
                    ...
                    Drawable shadowDrawable = Theme.getThemedDrawable(getContext(), com.chickengram.messenger.R.drawable.greydivider, Theme.getColor(Theme.key_windowBackgroundGrayShadow, resourceProvider));
        ...
        listView.setOnItemClickListener((view, position) -> {
            ...
            if (item.viewType == VIEW_TYPE_HEADER) {
                ...
                try {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", com.chickengram.messenger.R.string.Cancel), null);
